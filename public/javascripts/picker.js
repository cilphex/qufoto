...
function TCPopup(field, palette) {
	...
	o_colWindow = window.open('picker', null, "help=no,status=no,scrollbars=no,resizable=no" + move + ",width=" + w + ",height=" + h + ",dependent=yes", true);
...
function TCSelect(c) {
	...
	$(this.field.name + '_div').style.background = '#' + c.toUpperCase();
